                                ...
                                <div class="col-sm-6">
                                    <table class="table table-sm table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox ID="TXT_SEARCH_UPLINER" runat="server"></asp:TextBox>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td>Upliner 2</td>
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox ID="TXT_SEARCH_UPLINER2" runat="server"></asp:TextBox>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td>Upliner 3</td>
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox ID="TXT_SEARCH_UPLINER3" runat="server"></asp:TextBox>&nbsp;</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                                                    ...
                                                    <td valign="top">
                                                                ...
                                                                <dx:PanelContent ID="PanelContent2" runat="server">
                                                                    <table class="table table-sm table-responsive">
                                                                        <tr>
                                                                            ...
                                                                            <td>:</td>
                                                                            <td>
                                                                                <asp:TextBox ID="TXT_USERID" runat="server" CssClass="mandatory"></asp:TextBox>
                                                                                <input type="button" class="Bt1" id="btn_cekAD" runat="server" value="Cek AD User" onclick="callbackpopup(popup, panel, 'new');" />&nbsp;
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Full Name</td>
                                                                            <td>:</td>
                                                                            <td>
                                                                                <asp:TextBox ID="TXT_SU_FULLNAME" runat="server" Width="250px" CssClass="mandatory" onchange="document.form1.panelNama_hdn_nama.value=this.value;"></asp:TextBox>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>:</td>
                                                                            <td>
                                                                                <asp:DropDownList ID="DDL_GROUPID" runat="server" Width="250px" AutoPostBack="True" CssClass="mandatory" OnSelectedIndexChanged="DDL_GROUPID_SelectedIndexChanged"></asp:DropDownList></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Password</td>
                                                                            <td>:</td>
                                                                            <td>
                                                                                <asp:TextBox ID="TXT_SU_PWD" runat="server" CssClass="mandatory" TextMode="Password"></asp:TextBox></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Verify</td>
                                                                            <td>:</td>
                                                                            <td>
                                                                                <asp:TextBox ID="TXT_VERIFYPWD" runat="server" CssClass="mandatory" TextMode="Password"></asp:TextBox></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>HP No.</td>
                                                                            <td>:</td>
                                                                            <td>
                                                                                <asp:TextBox ID="TXT_SU_HPNUM" runat="server"></asp:TextBox></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Email</td>
                                                                            <td>:</td>
                                                                            <td>
                                                                                <asp:TextBox ID="TXT_SU_EMAIL" runat="server" Width="250px" onchange="document.form1.panelNama_hdn_email.value=this.value;"></asp:TextBox>
                                                        ...
                                                        <table class="table table-sm table-responsive">
                                                            ...
                                                            <tr style="display: none">
                                                                ...
                                                                <td>:</td>
                                                                <td>
                                                                    <asp:DropDownList ID="ddl_JenisUser" runat="server">
                            ...
                            <dx:PanelContent ID="PanelContent1" runat="server">
                                <table width="100%" class="table table-sm table-responsive">
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <asp:TextBox runat="server" ID="LDAPUser" onkeydown="tabE(event)"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td align="left">Password</td>
                                        <td>:</td>
                                        <td>
                                            <asp:TextBox runat="server" ID="LDAPPwd" TextMode="Password" onkeydown="tabE(event)"></asp:TextBox>
                                            <asp:TextBox runat="server" ID="LDAPPwd2" Style="display: none"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">
                                            <input type="button" class="Bt1" runat="server" id="btnValidateUserAD" value="OK" onclick="callbackpopup(popup, panel, 'cek', panelNama);" />
                                            <input type="button" class="Bt1" runat="server" id="btnCancelValidate" value="Cancel" onclick="popup.Hide();" />
                                        </td>
                                    </tr>
                                </table>
                            </dx:PanelContent>
