            ...
            <div class="row">
                <div class="col-sm-12">
                    <dx:ASPxPageControl ID="PageCtrl" runat="server" ActiveTabIndex="0"
                        Width="100%" Theme="MaterialCompact">
                        <TabPages>
                                                ...
                                                <dx:GridViewDataColumn Caption="Function" VisibleIndex="1" Width="1%">
                                                    ...
                                                    <HeaderTemplate>
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <input class="btn btn-sm btn-info mr-1" type="button" value="New" onclick="popup$panel$USC_paraminput1$clrButton.click(); popup.Show()" />
                                                                </td>
                                                            </tr>
                                                            <tr class="<%=funcCss %>">
                                                                <td>
                                                                    <input class="btn btn-sm btn-info" type="button" onclick="grid.ExpandAll();" value=" Expand All " />
                                                                </td>
                                                            </tr>
                                                            <tr class="<%=funcCss %>">
                                                                <td>
                                                                    <input class="btn btn-sm btn-info mr-1" type="button" onclick="grid.CollapseAll();" value="Collapse All" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <DataItemTemplate>
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <input class="btn btn-sm btn-info mr-1" type="button" value="Edit" onclick="<%# "popup.Show();panel.PerformCallback('r:" + Container.KeyValue.ToString().Replace("'","\\'") + "')"%>" />
                                                                </td>
                                                                <td>
                                                                    <input class="btn btn-sm btn-info mr-1 deleteData" type="button" value="Delete" data-id="<%#Container.KeyValue.ToString() %>" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </DataItemTemplate>
                                                    ...
                                                    <HeaderTemplate>
                                                        <table>
                                                            <tr class="<%=funcpendCss %>">
                                                                <td>
                                                                    <input class="btn btn-sm btn-info mr-1" type="button" onclick="gridpending.ExpandAll();" value=" Expand All " />
                                                                </td>
                                                            </tr>
                                                            <tr class="<%=funcpendCss %>">
                                                                <td>
                                                                    <input class="btn btn-sm btn-info mr-1" type="button" onclick="gridpending.CollapseAll();" value="Collapse All" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </HeaderTemplate>
                                                        ...
                                                        <table>
                                                            <tr>
                                                                <td class="<%# "pending" + Eval("__STATUS").ToString() %>">
                                                                    <input class="btn btn-sm btn-info mr-1" type="button" value="Edit" onclick="<%# "popup.Show();panel.PerformCallback('rp:" + Container.KeyValue.ToString().Replace("'","\\'") + "')"%>" />
                                                                </td>
                                                                <td>
                                                                    <input class="btn btn-sm btn-info mr-1" type="button" value="Delete" onclick="<%# "gridpending.PerformCallback('dp:" + Container.KeyValue.ToString().Replace("'","\\'") + "')"%>" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </DataItemTemplate>
