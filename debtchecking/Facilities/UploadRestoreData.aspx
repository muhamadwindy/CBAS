<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadRestoreData.aspx.cs" Inherits="DebtChecking.Facilities.UploadRestoreData" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table width="50%" align="center" class="Box1" id="tbl_upload">
                <tr>
                    <td colspan="3" align="center" class="H1">Upload Restore Data</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3" align="center">
                        <input id="btnSave" runat="server" class="Bt1" onclick="this.disabled = true;
