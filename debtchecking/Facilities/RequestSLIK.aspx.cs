...
";
        ...
        {
            DataTable dt = conn.GetDataTable("select *,FORMAT (dob, 'dd MMMM yyyy ')as DOB_ddmmyyyy, rel_desc as relation from apprequestsupp left join rfrelationbic " +
        ...
        private string validateSubmitAndSaveApp()
        {
            ...
            if (cust_name.Text == "")
            {
                message += "Nama Customer Harus Diisi" + Environment.NewLine;
            }
            if (dob.Text == "")
            {
                message += "Tgl Lahir/Pendirian Harus Diisi" + Environment.NewLine;
            }
            if (ktp.Text == "")
            {
                message += "Nomor KTP/AKTA  Harus Diisi" + Environment.NewLine;
            }
            ...
            if (pob.Text == "")
            {
                message += "Tempat Lahir Harus Diisi" + Environment.NewLine;
            }
            if (gender.SelectedIndex == -1)
            {
                message += "Jenis Kelamin Harus Diisi" + Environment.NewLine;
            }

            if (mother_name.Text == "")
            {
                message += "Nama Ibu Kandung Harus Diisi" + Environment.NewLine;
            }
            if (homeaddress.Text == "")
            {
                message += "Alamat Harus Diisi" + Environment.NewLine;
            }
            if (phonenumber.Text == "")
            {
