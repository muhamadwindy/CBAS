...
<%@ Register Assembly="MWSControls" Namespace="MWSControls" TagPrefix="cc1" %>
                                ...
                                <div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label">
                                                    <asp:Label ID="labelTanggalLahir" runat="server"></asp:Label>
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-sm-8">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label">
                                                    NPWP No.
                                                    <span id="iconMandatoryNPWP" runat="server" class="text-danger">*</span>
                                                </label>
                                                <div class="col-sm-8">
                                                    <asp:TextBox ID="npwp" runat="server" CssClass="form-control form-control-sm" MaxLength="15" onkeypress="return digitsonly();" onpaste="if(parseInt(clipboardData.getData('Text')) != clipboardData.getData('Text')) return false;"></asp:TextBox>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <asp:TextBox ID="NoAplikasi" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                                                </div>
                                            </div>

                                            <div class="form-group row" runat="server" id="tr_PICName">
                                                <label class="col-sm-4 col-form-label">
                                                    Nama PIC
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-sm-8">
                                                    <asp:TextBox ID="PICName" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                                                </div>
                                            </div>
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <cc1:TXT_CURRENCY runat="server" ID="OTR"
                                                                            CssClass="form-control form-control-sm numericdouble" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
