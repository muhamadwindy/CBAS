                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <asp:DropDownList ID="productid" runat="server" CssClass="form-control form-control-sm input-sm autofillflag"></asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <asp:DropDownList ID="purpose" runat="server" CssClass="form-control form-control-sm"></asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <PanelCollection>
                                                            ...
                                                            <dx:PanelContent ID="PanelContent3" runat="server">
                                                                ...
                                                                <asp:GridView ID="GridViewSuppl" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Record Found!"
                                                                    ...
                                                                    <Columns>
                                                                        <asp:BoundField HeaderText="Nama" DataField="cust_name"></asp:BoundField>
                                                                        <asp:BoundField HeaderText="Hubungan" DataField="relation"></asp:BoundField>
                                                                        <asp:BoundField HeaderText="Tgl Lahir/Pendirian" DataField="DOB_ddmmyyyy"></asp:BoundField>
                                                                        <asp:BoundField HeaderText="Nomor KTP/Akta" DataField="ktp"></asp:BoundField>
                                                                        <asp:BoundField HeaderText="NPWP" DataField="npwp"></asp:BoundField>
                                                                        <asp:BoundField HeaderText="Alamat" DataField="homeaddress"></asp:BoundField>
                                                                        <asp:BoundField HeaderText="Telp" DataField="phonenumber"></asp:BoundField>
                                                                        <asp:TemplateField>
